...
import NavbarPage from '../home/TopNav.jsx';
...
class ChallanTemplate extends Component {
  ...
  download() {
    ...
    html2canvas(document.getElementById('challan'), {
      scale: '5',
    }).then((canvas) => {
      console.log('Capturando');
      this.imgFile = canvas;
      doc.addImage(this.imgFile, 'JPEG', 5, 5, 200, 170);
      ...
      return (
        <div>
          ...
          <Card style={{ marginLeft: '2rem', marginRight: '2rem' }}>
            ...
            <CardBody style={{ height: '40rem', border: '1px solid' }}>
              <div
                id="challan"
                style={{
                  marginTop: '6rem',
              ...
              >
                ...
                <div
                  ...
                  className="cls_002"
                >
                  <span className="cls_002">Late Payment Fine </span>
                </div>
                <div
                ...
                <div
                  ...
                  className="cls_002"
                >
                  <span className="cls_002">Per Day:</span>
                </div>
                <div
